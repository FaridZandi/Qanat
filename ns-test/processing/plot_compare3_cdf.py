...
def plot_measure(measure):
    ...
    new_df = pd.concat([df1, df2, df3], keys=['1-Level', "2-Levels", "3-Levels"]).reset_index(); 
    new_df[measure] /= 1000
    ...
    plt.legend(title='Prioritization', loc='lower right', labels=['3-Levels', "2-Levels", "1-Level"])
