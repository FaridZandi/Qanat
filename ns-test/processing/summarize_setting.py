...
if args.reload: 
    ...
    try: 
        print ("Summarising exp: " + args.directory)
        exp_info = {}
        ...
        # load the data files 
        data_directory = args.directory + "/data/"
        ...
        try: 
            ...
            exp_info["bg_50_afct"] = 0
            exp_info["bg_75_afct"] = 0
            exp_info["bg_90_afct"] = 0
            exp_info["bg_100k_afct"] = 0
            exp_info["bg_big_afct"] = 0
            exp_info["bg_50_ret"] = 0 
            exp_info["bg_75_ret"] = 0 
            exp_info["bg_90_ret"] = 0 
            exp_info["bg_100k_ret"] = 0 
            exp_info["bg_big_ret"] = 0 
        ...
        df = pd.concat([df, pd.DataFrame([exp_info])], ignore_index=True)
