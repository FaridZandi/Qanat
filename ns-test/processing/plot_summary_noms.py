...
if plot_name == "prio_test":
    plot_exp_bar({
        ...
        "metrics": ["tnld_pkt_cnt", "max_bpq", "tot_mig_time"],
...
if plot_name == "parallel_test":
    plot_exp_bar({
        ...
        "hue_setting": ["oversub"],
        "repeat_per": ["gw_snapshot_size"],
        "metrics": ["tnld_pkt_cnt", "vm_99_ptk_in_flight_t", "tot_mig_time"],
...
if plot_name == "bg_test":
    plot_exp_bar({
        ...
        "metrics": ["tnld_pkt_cnt", "vm_afct", "vm_99_ptk_in_flight_t", "bg_100k_afct", "bg_big_afct"],
