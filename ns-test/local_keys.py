		...
		for eventual_timeout in eventual_timeouts:
			for access_mode in access_modes:
				for local_storage_rate in local_storage_rates:
					...
					directory_name = 'results_local_keys/%d_%s_%f_%i_%i_%i' % (int(load*100), access_mode_name, eventual_timeout, key_type, topology_shape, i)
