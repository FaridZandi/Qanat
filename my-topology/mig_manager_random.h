#ifndef mig_manager_random_h
#define mig_manager_random_h
...
class MigrationManagerRandom : public MigrationManager {
public:
    MigrationManagerRandom(); 
    virtual ~MigrationManagerRandom(); 
